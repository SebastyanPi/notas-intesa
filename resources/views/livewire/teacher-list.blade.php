    ...
    <div>
        <div class="container-fluid my-3">
            <div class="mb-3 d-flex justify-content-end">
                <div>
                    <a href="{{ route('user.register', 'teacher') }}" id="invisible" class="btn-n-small btn-n-primary"  style="font-size: 15px"><i class="fas fa-plus"></i></a>
                    <a target="__blank" href="{{ route('teacher.index.pdf') }}" class="btn-n-small btn-n-danger-outline"  style="font-size: 15px"><i class="fas fa-download"></i><b>PDF</b></a>
                </div>
            </div>
            ...
            <table class="table align-items-center mb-0" style="overflow:scroll;max-height:400px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <b>
                                <span class="badge badge-sm bg-informative"> {{ $item->nit }}</span>
                            </b>
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                            <a href="{{ route('users.edit', ["id" => $item->id, "before" => "teacher"]) }}"><i class="fas fa-edit"></i></a>
                        </td>
                    </tr>
                    @endforeach
