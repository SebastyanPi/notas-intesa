...
use App\Http\Livewire\TableComponent;  
	...
	Route::get('/', function () {return redirect()->route('program.index');})->middleware('auth');
	...
	Route::group(['middleware' => 'auth'], function () {
		...
		Route::get('teacher/campus-formacion/{cedula}', [StudentController::class, 'campus_formacion'])->middleware('can:user.teacher.index')->name('user.teacher.campus.formacion'); 
		//Route::get('teacher/campus-virtual', [TeacherController::class, 'page_teacher'])->middleware('can:user.teacher.index')->name('user.teacher.index');
